...
const ARTICLES: ArticleMeta[] = [
...

  {
    ...
    content: (s) => ({
      paragraphs: [
        `Bach\u2019s harmonic vocabulary is enormous compared to most of his contemporaries. Where a simpler style might use six or seven chord types, a typical Bach chorale deploys about ${s.avg_unique_chords || '14'} distinct sonorities, including inversions, seventh chords, secondary dominants, Neapolitan sixths, augmented sixth chords, and chords borrowed from the parallel mode.`,
        ...
        'Bach\u2019s cadences fall into clear categories: perfect authentic (V\u2013I with the soprano on the tonic), imperfect authentic, half cadence (ending on V), Phrygian half cadence (iv\u2076\u2013V with the bass descending by semitone \u2014 the standard minor-key half cadence), deceptive (V going somewhere unexpected, usually vi), and plagal (IV\u2013I). But the genius is in how he prepares them. A perfect cadence often arrives after several beats of harmonic tension \u2014 suspensions in the upper voices, chromatic passing tones in the bass \u2014 so that the resolution feels earned rather than routine.',
      ...
      stats: [
        ...
        { label: 'Cadence types', value: Object.keys((s.cadence_type_distribution as Record<string, number>) || {}).join(', ') || 'PAC, IAC, HC, PHC, DC, PC' },
      ],
      tryIt: [
